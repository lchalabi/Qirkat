...
public class MoreBoardTests {
    ...
    public void testsetPieces() {
    	...
    	String roworder =
                " w w w w w\n  w w w w w\n  b b "
                        + "- w w\n  b b b b b\n  b b b b b";
        b.setPieces(roworder, PieceColor.WHITE);
    ...
    public void testjumpPossible() {
        Board b = new Board();
        String roworder = new StringBuilder("b---w -b-w- --b-- --wb- w---b")
                .reverse().toString();
        b.setPieces(roworder, PieceColor.BLACK);
        assertEquals(b.jumpPossible(), true);
    }
